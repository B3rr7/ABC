...
| **C** | ব্যাকরণ (Grammar) | 15 core sentence patterns with fill-in-the-blank drills and a per-pattern mastery ring. |
| **D** | পড়া (Reading) | 6 tech-flavored passages; tap any word to hear it and see a Bengali gloss. Plus a box to paste your own README/docs. Comprehension questions are scored per passage. |
